...
if (process.env.jd_cjhy_activityId) jd_cjhy_activityId=process.env.jd_cjhy_activityId
if (process.env.jd_cjhy_activityUrl) jd_cjhy_activityUrl=process.env.jd_cjhy_activityUrl
