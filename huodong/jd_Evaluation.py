    ...
    if _class == 1:
        ...
        datas = {
            1: {
                ...
                "结束": [
                    "经过了这次愉快的购物，我决定如果下次我还要买$的话，我一定会再来这家店买的。为了评论得到几个京豆，所以，这些是凑字数的！",
                    "不错不错！为了评论得到几个京豆，所以，这些是凑字数的！",
                    "我会推荐想买的朋友也来这家店里买 为了评论得到几个京豆，所以，这些是凑字数的！",
                    "真是一次愉快的购物！为了评论得到几个京豆，所以，这些是凑字数的！",
                    "大大的好评!以后买$再来你们店！(￣▽￣) 为了评论得到几个京豆，所以，这些是凑字数的！",
                    "推荐呦 为了评论得到几个京豆，所以，这些是凑字数的！"
                ]
            },
            0: {
                "开始": [
